...
public class SkillsHelper {
	...
	/**
	 * Save the amount of XP of each skill so we can look back at it later (for
	 * paint, antiban etc) Make sure to call this AFTER login.
	 */
	...
	/**
	 * Save the amount of XP of specific skills so we can look back at it later
	 * (for paint, antiban etc) Make sure to call this AFTER login.
	 *
	 * @param skills
	 *            - array of skills to save.
	 */
	...
	/**
	 * Get the list of all skills and start XP which were set by
	 * setStartSkills()
	 *
	...
	/**
	 * Get's the amount of XP we gained in a skill. Make sure setStartSkills()
	 * was called on this skill.
	 *
	 * @param skill
	 *            to check
